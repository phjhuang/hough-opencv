...
void kalmanProcess(kalman_s *mykalman)
{
	...
	multiplyMatrix(mykalman->A,NS,NM,mykalman->X,NS,1,mykalman->temp_1);                //X=A*X
	for (i=0;i<NS;i++)
	...
	//第四个公式：K = P*H'/[H*P*H'+R]
	transpositionMatrix(mykalman->H,mykalman->temp_4_3,NS,NM);                      //temp_4_3 = H'
	multiplyMatrix(mykalman->P,NS,NS,mykalman->temp_4_3,NS,NM,mykalman->temp_4_1);    //temp_4_1 = P*H'
	multiplyMatrix(mykalman->H,NS,NS,mykalman->temp_4_1,NS,NS,mykalman->temp_4_2);    //temp_4_2 =H*P*H'
